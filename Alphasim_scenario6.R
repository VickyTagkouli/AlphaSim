...
library(AlphaSimR)
######Scenario 6 for selection of 800 best plants in each cycle with 12 seeds per plant to generate a pop of 10000 for the next cycle#####
...
selection=800 ; selectedSeeds=12 ; fabaSelf=0.25
##################################################################################
...
write.table(Genetic_variation, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Variation_values6.10.txt", sep="\t")
write.table(Genetic_gain, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Gain_values6.10.txt", sep="\t")
