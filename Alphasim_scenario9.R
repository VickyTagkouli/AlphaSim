...
library(AlphaSimR)
######Scenario 9 for selection of 1600 best plants in each cycle with 12 seeds per plant to generate a pop of 40000 for the next cycle#####
...
selection=1600 ; selectedSeeds=12 ; fabaSelf=0.25
##################################################################################
...
write.table(Genetic_variation_scenario2, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Variation_values9.10.txt", sep="\t")
write.table(Genetic_gain_scenario2, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Gain_values9.10.txt", sep="\t")
