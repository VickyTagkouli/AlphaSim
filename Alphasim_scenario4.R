...
selection=200 ; selectedSeeds=50 ; fabaSelf=0.25
##################################################################################
...
write.table(Genetic_variation, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Variation_values4.10.txt", sep="\t")
write.table(Genetic_gain, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Gain_values4.10.txt", sep="\t")
