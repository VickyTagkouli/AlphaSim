...
library(AlphaSimR)
######Scenario 1 for selection of 20 best plants in each cycle with 50 seeds per plant#####
...
selection=20 ; selectedSeeds=50 ; fabaSelf=0.25
##################################################################################
...
write.table(Genetic_variation, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Variation_values1.10.txt", sep="\t")
write.table(Genetic_gain, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Gain_values1.10.txt", sep="\t")
