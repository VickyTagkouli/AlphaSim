...
library(AlphaSimR)
######Scenario 7 for selection of 400 best plants in each cycle with 50 seeds per plant to generate a pop of 40000 for the next cycle#####
...
selection=400 ; selectedSeeds=50 ; fabaSelf=0.25
##################################################################################
...
write.table(Genetic_variation_scenario2, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Variation_values7.10.txt", sep="\t")
write.table(Genetic_gain_scenario2, "/Users/vickytagkouli/Desktop/AlphaSim_R_scripts/R.Gain_values7.10.txt", sep="\t")
